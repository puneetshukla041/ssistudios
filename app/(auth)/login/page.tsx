...
// Helper for cleaner async delays
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Execute Success Sequence (Async/Await for readability)
      await delay(600);
      setIsLoading(false);
      setFlowState(prev => ({ ...prev, showTick: true }));
      
      await delay(500);
      setFlowState(prev => ({ ...prev, showTick: false, showWelcome: true }));
      
      await delay(800);
      setFlowState(prev => ({ ...prev, showWelcome: false }));
