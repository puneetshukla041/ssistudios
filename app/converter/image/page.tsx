        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            <motion.div
              ...
              className="bg-white/40 backdrop-blur-3xl border border-white/60 rounded-[32px] md:rounded-[48px] p-3 md:p-4 shadow-[0_20px_50px_rgba(0,0,0,0.04)]"
            >
              <div 
                {...getRootProps()} 
                className={`relative cursor-pointer rounded-[24px] md:rounded-[38px] border-2 border-dashed transition-all duration-500 min-h-[300px] md:min-h-[400px] flex flex-col items-center justify-center p-6 md:p-12
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {files.map((file, idx) => (
                      <motion.div 
                        ...
                        className="flex items-center justify-between p-4 md:p-5 bg-white/60 backdrop-blur-md border border-white/80 rounded-[24px] md:rounded-[28px] shadow-sm"
                      >
            ...
            <div className="bg-white/70 backdrop-blur-3xl rounded-[32px] md:rounded-[48px] p-6 md:p-8 border border-white shadow-[0_30px_60px_rgba(0,0,0,0.05)] sticky top-8">
              ...
              <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {SUPPORTED_FORMATS.map(f => (
                      <button 
                        ...
                        className={`py-4 rounded-2xl text-sm font-bold transition-all duration-300 border cursor-pointer ${
                          targetFormat === f 
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className={`w-full py-5 rounded-[22px] md:rounded-[26px] flex items-center justify-center gap-3 text-white font-black text-lg transition-all cursor-pointer
                    ${isCompleted ? 'bg-[#34C759]' : 'bg-[#007AFF] shadow-[0_15px_30px_rgba(0,122,255,0.15)]'}
              ...
              {isCompleted && (
                 ...
                 >
                   ...
                   <span className="text-xs font-bold text-[#34C759]">Ready for download</span>
                 </motion.div>
              )}
            </div>
          </div>
